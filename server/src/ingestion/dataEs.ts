...
export function toBoulodrome(equipement: DataEsEquipementRecord, installation: DataEsInstallationRecord): Boulodrome {
    const address = new Address(installation.adresse, installation.cp, installation.commune, installation.insee)
    const coordinates = new GeoCoordinates(equipement.coordonnees.lat, equipement.coordonnees.lon)
