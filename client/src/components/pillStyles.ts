...
// parent manque de place (scroll horizontal, App.tsx, ticket 34) - une
// hauteur fixe (`h-6`) combinee a du texte sur deux lignes casserait la
// forme de la pilule.
...
// enfant de conteneur flex se compresse par defaut quand la rangee manque de
// place - ce groupe doit au contraire garder sa largeur naturelle et
// deborder du conteneur scrollable (App.tsx, `overflow-x-auto`, ticket 34)
// plutot que de compresser ses segments (meme raison que `whitespace-nowrap`
// ci-dessus).
